 ...
 *   via environment variables, use the `MOL_` prefix and double underscore
 *   `__` for nested properties in .env file.
...
module.exports = {
  ...
  logLevel: 'info',
  // Log formatter for built-in console logger.
  // Available values: default, simple, short. It can be also a `Function`.
